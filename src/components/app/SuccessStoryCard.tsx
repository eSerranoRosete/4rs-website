...
export const SuccessStoryCard = ({ item }: Props) => {
  return (
    <Link
      ...
      className="group relative aspect-square w-96 cursor-pointer overflow-hidden rounded p-8 hover:opacity-90"
    >
      ...
      <img
        ...
        className="absolute left-0 top-0 h-full w-full object-cover object-center transition-transform duration-700 group-hover:scale-110"
      />
    </Link>
  );
};

...
export const Hero = () => {
  ...
  return (
    <div ref={ref} className="dark bg-background">
        ...
        <div className="relative h-full w-full overflow-hidden">
          ...
          <Container className="flex h-full flex-col items-center justify-center md:block">
            <div className="items relative z-20 m-auto flex h-full flex-col justify-center px-6 text-white">
              ...
              >
                <motion.h1
                  ...
                  className="max-w-4xl text-balance text-center text-5xl font-semibold tracking-tight md:text-left md:text-8xl"
                >
                ...
                <motion.p
                  ...
                  className="max-w-xl rounded-tl-2xl p-3 text-center text-base antialiased md:text-left md:text-xl"
                >
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              style={{ y }}
              className="relative bottom-5 z-10 flex scale-90 flex-wrap items-center justify-center gap-5 md:absolute md:bottom-10 md:right-10 md:gap-10"
            >
              <img
